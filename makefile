chess: ChessMain.o ChessBoard.o Piece.o King.o Queen.o Rook.o Knight.o Bishop.o Pawn.o
	g++ -g ChessMain.o ChessBoard.o Piece.o King.o Queen.o Rook.o Knight.o Bishop.o Pawn.o -o chess
